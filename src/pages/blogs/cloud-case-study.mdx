...
export const blog = {
  ...
  description:
    'Several examples of real-world investigations across cloud platform compromises in AWS, Azure, and GCP.',
...
<SEO
  title="Cloud Case Studies"
  description="Several examples of real-world investigations across cloud platform compromises in AWS, Azure, and GCP."
/>
...
<br />
<blockquote> Records have been modified from its original form per NDA restrictions.</blockquote>
<br />
```python
"TimeGenerated": "2024-05-18T14:30:00Z",
