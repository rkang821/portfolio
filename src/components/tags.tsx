export function MicrosoftTag(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
...
export function GCPTag(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
...
export function AWSTag(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
...
export function PhishingTag(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
...
export function AITag(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
...
export function BECTag(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
...
export function RWTag(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <span className="me-2 rounded border border-orange-400 bg-orange-100 px-2.5 py-0.5 text-xs font-medium text-orange-800 dark:bg-gray-700 dark:text-orange-400">
      RW
    </span>
  )
}
