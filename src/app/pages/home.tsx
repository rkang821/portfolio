      ...
      <div className="max-lg:row-span-5">
        ...
        <div className="prose space-y-4 text-base dark:prose-invert max-sm:text-center max-sm:text-lg">
          ...
          <p>
            ...
            <span className="font-semibold">Microsoft&apos;s Azure </span>ecosystem, I 
            specialize in managing complex incidents and navigating high-stakes environments breaches within cloud platforms. I&apos;m
            fascinated by the intricacies and complexities emerging within cloud
            forensics and the evolving challenges posed by such emerging threats.
          </p>
        </div>
      </div>
    </Container>
